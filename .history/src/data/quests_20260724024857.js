...
export const GUILD_QUESTS = [
  {
    id: "nova-cloud",
    logo: { src: "/images/experiences/nova-cloud-logo.png", alt: "NOVA Cloud logo", href: "https://gonovacloud.com/" },
    rank: "S",
  ...
  {
    id: "gmu-research",
    logo: { src: "/images/experiences/gmu-logo.jpg", alt: "George Mason University logo", href: "https://www.gmu.edu/", background: "#005239" },
    rank: "S",
    ...
    media: [
      {
        type: "image",
        src: "/images/experiences/gmu-research-presentation-wide.jpeg",
        alt: "Sunmay speaking during the AI research presentation at MIT URTC",
        objectPosition: "center 42%"
      },
      {
        type: "image",
        src: "/images/experiences/gmu-research-slide.webp",
        alt: "Prompt-engineering research background slide presented at MIT URTC",
        objectPosition: "center"
      },
      {
        type: "image",
        src: "/images/experiences/gmu-paper-abstract.png",
        alt: "Abstract of the paper evaluating four prompting techniques on advanced Codeforces problems",
        objectPosition: "top"
      }
    ],
    bullets: [
  ...
  {
    id: "cybersages",
    logo: { src: "/images/experiences/first-logo.jpg", alt: "FIRST logo", href: "https://www.firstinspires.org/" },
    rank: "A",
    ...
    media: [
      {
        type: "image",
        src: "/images/experiences/cybersages-team.jpeg",
        alt: "CyberSages robotics team together at a FIRST Chesapeake competition"
      },
      {
        type: "video",
        src: "/videos/experiences/cybersages-robot-demo.mp4",
        label: "CyberSages robot demonstration"
      },
      {
        type: "image",
        src: "/images/experiences/cybersages-robot.jpeg",
        alt: "CyberSages competition robot on a practice field",
