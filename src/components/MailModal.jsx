...
function MailModal({
  ...
  return <div role="presentation" onClick={() => { beep(220); setOpenLetterId(null); }} style={{
    position: "fixed",
    inset: 0,
    background: `${T.bg}cc`,
    zIndex: 998,
    ...
    padding: 20
            ...
            <div role="dialog" aria-modal="true" aria-label={`${letter.subject} message`} onClick={e => e.stopPropagation()} style={{
      background: T.panel,
      ...
      margin: "10px"
        ...
        boxShadow: `2px 2px 0 ${T.bg}`
              ...
              <button type="button" onClick={() => { beep(220); setOpenLetterId(null); }} title="Close" aria-label="Close message" style={{
        appearance: "none",
        background: "none",
        border: 0,
        padding: 0,
