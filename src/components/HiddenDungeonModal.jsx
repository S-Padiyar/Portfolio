    ...
    <header className="modal-journal-header" style={{ borderColor: theme.border }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ minHeight: 38, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ fontFamily: pixelFont, fontSize: `${14 * fontScale}px`, color: theme.accent, lineHeight: 1.15 }}>Dungeon Journal</div>
          <div style={{ fontFamily: "var(--copy-font)", fontSize: `${12 * fontScale}px`, color: theme.textDim, lineHeight: 1.3, marginTop: 0 }}>
