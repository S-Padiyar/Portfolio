...
export default function GalleryImage({ image, onInfo, theme }) {
  ...
  const frame = <div style={{ position: "relative", width: "100%", aspectRatio: image.aspectRatio || "16 / 9", overflow: "hidden", background: theme.panelAlt, border: `1px solid ${theme.border}` }}>
